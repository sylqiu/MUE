...
class TestModelLib(unittest.TestCase):
    ...
    def test_discrete_posterior_encoder(self):
        ...
        PARAM = configure_param.get_discrete_posterior_encoder_param(LATENT_CODE_DIMENSIONS)
    ...
    def test_discrete_prior_encoder(self):
        ...
        PARAM = configure_param.get_discrete_prior_encoder_param(LATENT_CODE_DIMENSIONS)
        inputs = torch.ones((BATCHSIZE, LATENT_CODE_DIMENSIONS, HEIGHT, WIDTH),
                        dtype=torch.float32)
