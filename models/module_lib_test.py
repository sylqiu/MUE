import unittest
import torch
from layer_lib_test import DOWNSAMPLE_SCALE, KERNEL_SIZE_LIST
import module_lib
...
class TestModuleLib(unittest.TestCase):
    def test_unet_encoder(self):
        ...
        module = module_lib.UnetEncoder(INPUT_CHANNELS, ENCODER_CHANNEL_LIST, 
                             KERNEL_SIZE_LIST, DOWNSAMPLE_LIST, ENCODER_OUTPUT_LEVEL_LIST,
    ...
    def test_unet_decoder(self):
        ...
        module = module_lib.UnetDecoder(inputs[0].shape[1], DECODER_CHANNEL_LIST, 
                             KERNEL_SIZE_LIST, SKIP_CHANNEL_LIST, DECODER_OUTPUT_LEVEL_LIST,  
                             NORMALIZATION_CONFIG)
        outputs = module(inputs)
